...
const SENSITIVE_KEYS: (keyof ApiConfig)[] = ["zhanhuKey", "seedance", "supabaseKey"];
      ...
      <main className="max-w-xl mx-auto p-6 space-y-6">
        ...
        <div className="space-y-4">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              {[
                { name: "gemini", label: "Gemini API 端点", configKey: "zhanhuEndpoint" as const, apiKeyField: "zhanhuKey" as const, placeholder: "http://202.90.21.53:13003/v1beta", hint: "只需填写 Base URL，路径会自动拼接" },
